...
ENABLED_TOOLS="Generalist_Solution_Generator_Tool,Calculator_Tool,Search_Engine_Tool,Url_Text_Extractor_Tool,Wiki_Search_Tool,Visual_Ai_Tool,Arxiv_Paper_Search_Tool"
AGENTS="opentools"
mkdir -p $LOG_DIR
