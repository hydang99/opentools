...
class ResultScorer:
    def __init__(self, llm_engine=None):
        self.llm_engine = llm_engine or ChatOpenAI(model_string="gpt-5-mini", is_multimodal=False, enable_cache=True)
    ...
    def answer_verification(self, response, correct_answer):
        ...
        verification = self.llm_engine(query_prompt_open_tools, response_format=AnswerVerification)
