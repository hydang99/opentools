import os, sys, inspect, traceback, importlib, time
...
class Initializer:
    def __init__(self, enabled_tools: List[str] = [], model_string: str = None, verbose: bool = False, vllm_config_path: str = None):
        ...
        if self.model_string and self.model_string.startswith("vllm-"):
    ...
    def load_tools_and_get_metadata(self) -> Dict[str, Any]:
        ...
        tools_dir = os.path.join(opentools_dir, 'opentools')   
