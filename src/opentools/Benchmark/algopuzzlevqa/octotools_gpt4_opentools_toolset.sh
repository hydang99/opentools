...
ENABLED_TOOLS="Visual_AI_Tool,Colour_Hue_Solver_Tool,Calendar_Calculation_Tool,Woodslide_Solver_Tool,Board_Title_Solver_Tool,Rubik_Cube_Solver_Tool,N_Queens_Solving_Tool,Maze_Solving_Tool,Generalist_Solution_Generator_Tool"
AGENTS="octotools"
############
