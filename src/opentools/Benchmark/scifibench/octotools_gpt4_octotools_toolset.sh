...
ENABLED_TOOLS="Advanced_Text_Detector_Tool,Generalist_Solution_Generator_Tool,Wikipedia_Knowledge_Searcher_Octotools_Tool,Simple_ArXiv_Paper_Search_Tool"
AGENTS="octotools"
############
