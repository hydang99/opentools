...
class ResultScorer:
    ...
    def answer_verification(self,question, response, correct_answer):
        ...
        2. The answer is correct if it matches any of the correct answers:
           ...
           - If the response still indirectly answer the question, it should be marked as correct.
    ...
    def calculate_tool_usage(result_dir):
        ...
        for tool in tool_usage:
            tool_usage[tool] = round(tool_usage[tool] / total_problems, 3) if total_problems > 0 else 0.0
