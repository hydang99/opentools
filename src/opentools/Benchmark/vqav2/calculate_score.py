...
class ResultScorer:
    ...
    def answer_verification(self,question, response, correct_answer):
        ...
        List ofCorrect answer: {correct_answer}
        ...
        2. The answer is correct if:
           - It matches any of the correct answers semantically (e.g., "looking down" ≈ "down")
           - It expresses the same meaning in different words (e.g., "downward" ≈ "down")
           - It includes any of the correct answers with additional context that doesn't change the meaning
        3. The answer is incorrect if:
           - It conveys a different meaning
           - It's too vague or too specific compared to any of the correct answers
            ...
            try:
                ...
                if pid in benchmark_data:
                    ...
                    if "error" in result:
                        ...
                        results[pid]["correct_answer"] = benchmark_data[pid]["answer_gt"]
