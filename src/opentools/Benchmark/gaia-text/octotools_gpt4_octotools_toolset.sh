...
############
LABEL="gpt-4o-mini/OctoTools_OctoTools_Toolset"
RUN_ID="run_1"
THREADS=2
TASK="gaia-text"
...
ENABLED_TOOLS="Code_Generate_Execute_Tool,Google_Search_Octotools_Tool,Wikipedia_Knowledge_Searcher_Octotools_Tool,Url_Text_Extractor_Octotools_Tool,Generalist_Solution_Generator_Tool"
AGENTS="octotools"
############
