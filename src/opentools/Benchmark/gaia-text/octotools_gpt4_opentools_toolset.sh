...
############
LABEL="gpt-4o-mini/OctoTools_OpenTools_Toolset"
RUN_ID="run_1"
THREADS=2
TASK="gaia-text"
...
ENABLED_TOOLS="Generalist_Solution_Generator_Tool,Advance_Text_Detector_Tool,Text_Detector_Tool,Url_Text_Extractor_Tool,Nature_News_Fetcher_Tool,Arxiv_Paper_Search_Tool,Audio_Processing_Tool,Calculator_Tool,Chemistry_Search_Tool,Code_Generate_Execute_Tool,Csv_Extraction_Tool,Doc_Extraction_Tool,Download_File_Tool,Visual_Ai_Tool,Pdf_Extraction_Tool,Plain_Text_Extraction_Tool,Pptx_Extraction_Tool,Search_Engine_Tool,Wiki_Search_Tool,Xlsxe_Extraction_Tool,Yahoo_Finance_Tool,Youtube_Tool,Pubmed_Search_Tool,Video_Processing_Tool"
AGENTS="octotools"
############
